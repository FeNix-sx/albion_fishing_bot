"""
Распознавание пойманной рыбы:
1. Захват скриншота улова
2. Обработка изображения (OpenCV)
3. Сопоставление с шаблонами предметов
Возвращает название рыбы и количество.
"""
import cv2
import pytesseract
import re
